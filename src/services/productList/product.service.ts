...
export class ProductService {
  getProducts(): Product[] {
    ...
    return [
      new Product(1, 'Muzzarela', 'Pizza', 'Grande', 'Pizza con masa cacera, salsa de tomate, queso muzzarela, oregano y aceitunas', 'cayetano'),
      new Product(1, 'Calabresa', 'Pizza', 'mediana', 'Pizza con masa cacera, salsa de tomate, queso muzzarela, salame y aceitunas', 'cayetano'),
      new Product(1, 'Fugazzeta', 'Pizza', 'Grande', 'Pizza con masa cacera, salsa de tomate, queso muzzarela, cebolla, oregano y aceitunas', 'cayetano'),
